      ...
      >
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="image/46.jpg" class="d-block w-100" alt="Gambar 1" />
          </div>
          <div class="carousel-item">
            <img src="image/47.jpg" class="d-block w-100" alt="Gambar 2" />
          </div>
          <div class="carousel-item">
            <img src="image/78.jpg" class="d-block w-100" alt="Gambar 3" />
          </div>
        </div>
        <button
      ...
      <div class="container">
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-3 text-center text-md-start">
            <img src="https://p16-sign-sg.tiktokcdn.com/aweme/1080x1080/tos-alisg-avt-0068/71aac286042e724e350952edea3544bd.jpeg?lk3s=a5d48078&nonce=65017&refresh_token=3832e9e19c56674bf210ae6832e191a2&x-expires=1731117600&x-signature=YE%2Fe1kqy9QsrQ6onoVLWoNxkyk8%3D&shp=a5d48078&shcp=81f88b70" alt="aldispeed20" class="rounded-circle img-fluid" style="width: 250px; height: 250px; margin-top:20%;">
          </div>
          <div class="col-md-6 text-center text-md-start">
            <p>A11.2023.15056</p>
            <h2>Aldi Febriayanto</h2>
            <p>Program Studi Teknik Informatika<br>Universitas Dian Nuswantoro</p>
          </div>
        </div>
      </div>
    </section>
